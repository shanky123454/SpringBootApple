 ...
 * 
 * 
 * @Configuration public class SecurityConfigClassUsingInMemoryAuthentication {
 * 
 * @Autowired public DataSource dataSource;
 * 
 * 
 * @Autowired public Users tourist;
 * 
 * @Autowired public void configure(AuthenticationManagerBuilder auth) throws
 * Exception { auth.inMemoryAuthentication().withUser("shanky")
 ...
 * .requestMatchers("/api/tourist/register") .hasRole("USER")
 * .requestMatchers("/api/tourist/findAll") .hasRole("ADMIN")
 * .requestMatchers("/api/tourist/find/{id}") .hasRole("ADMIN")
 * .requestMatchers("/delete/{id}") .hasRole("ADMIN")
 * .requestMatchers("/api/tourist/modify") .hasRole("USER") //
 * .requestMatchers("/api/tourist/budgetModify/{id}/{hike}") //
 * .hasRole("ADMIN") .requestMatchers("/api/tourist/home") .permitAll()
