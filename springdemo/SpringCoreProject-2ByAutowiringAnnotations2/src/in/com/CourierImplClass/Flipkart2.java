...
/*
In Spring, the @Scope(value = prototype) annotation in a bean 
definition indicates that a new instance of the bean will be created
 each time it is requested from the container. 
 This is different from the default singleton scope, 
 where a single instance of the bean is created and reused
*/
