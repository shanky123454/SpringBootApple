	      ...
	      while(true)
	      {
	    	  ...
	    	  BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
				...
				case 3: System.out.println("enter the id to be searched");
						...
						StudentDTO dto1 =	service.getStudent((id1));
			   ...
			   System.out.println(bool);
				...
				case 13:
				List<StudentDTO> listdtos = service.findAll(true, "sage");
				...
				case 15:
					id =br.readLine();
				StudentDTO DTO =service.getReferenceById(Integer.parseInt(id));
				System.out.println(DTO);
					break;
					
				case 16:
				StudentBO bo = new StudentBO();	
				List<StudentDTO> dtu =service.findAll(bo);
				dtu.forEach(System.out::println);
				break;
				
				case 17:
					StudentBO book = new StudentBO();
				List<StudentDTO> dtoss =service.findAll(book, true);
				dtoss.forEach(System.out::println);
				break;
				}	
	      }catch(Exception e)
	    	  {
