...
@Entity
@Table(name = "MTM_MarutiSuzukiCar")
@Component
public class MarutiSuzukiCar {
	...
	@ManyToMany(targetEntity = Customer.class,mappedBy = "car",fetch = FetchType.EAGER,cascade = CascadeType.ALL)
	...
	/*
	 * @Override public String toString() { return "MarutiSuzukiCar [carNo=" + carNo
