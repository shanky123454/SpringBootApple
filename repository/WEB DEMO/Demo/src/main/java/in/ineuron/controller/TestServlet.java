...
public class TestServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ServletContext con = context.getServletContext();
		Enumeration<String> parameterNames = con.getInitParameterNames();
		while (parameterNames.hasMoreElements()) {
			String paramterName = (String) parameterNames.nextElement();
			String paramterValue = con.getInitParameter(paramterName);
			out.println("<tr>");
